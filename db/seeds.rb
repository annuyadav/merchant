...
m1 = Merchant.create(name: 'Annu', email: 'annu@gmail.com', status: 1, about: 'Software engineer', gender: 1, price: 100, review_count: 5, avg_rating: 4.5, session_time: 40)
m2 = Merchant.create(name: 'Praveen', email: 'praveen@gmail.com', status: 1, about: 'Software engineer', gender: 0, price: 80, review_count: 9, avg_rating: 5, session_time: 50)
m3 = Merchant.create(name: 'Sachin', email: 'sachin@gmail.com', status: 1, about: 'Engineer', gender: 0, price: 70, review_count: 7, avg_rating: 4, session_time: 20)
m4 = Merchant.create(name: 'Rajeev', email: 'rajeev@gmail.com', status: 1, about: 'Software developer', gender: 0, price: 90, review_count: 4, avg_rating: 3.5, session_time: 40)
m5 = Merchant.create(name: 'Ram', email: 'ram@gmail.com', status: 1, about: 'Developer', gender: 0, price: 50, review_count: 3, avg_rating: 3, session_time: 30)
m6 = Merchant.create(name: 'Aakanksha', email: 'aakanksha@gmail.com', status: 1, about: 'Software Trainee', gender: 1, price: 30, review_count: 2, avg_rating: 2, session_time: 60)
...
m8 = Merchant.create(name: 'Sonam', email: 'sonam@gmail.com', status: 1, about: 'Javascript developer', gender: 1, price: 20, review_count: 1, avg_rating: 2.5, session_time: 10)
m9 = Merchant.create(name: 'Roma', email: 'roma@gmail.com', status: 1, about: 'Marketing', gender: 1, price: 10, review_count: 4, avg_rating: 3, session_time: 30)
m10 = Merchant.create(name: 'Nimi', email: 'nimi@gmail.com', status: 1, about: 'HR', gender: 1, price: 30, review_count: 3, avg_rating: 3, session_time: 50)
